...
import { intarakai02Shader } from '../materials/intarakai04/Shader'
...
import vertexShader from '../materials/intarakai04/vertexShader.vert'
import fragmentShader from '../materials/intarakai04/fragmentShader.frag'
...
class Main {
  ...
  setup() {
    ...
    const geometry = new THREE.BoxBufferGeometry( 5, 2, 1, 1, 1 )
